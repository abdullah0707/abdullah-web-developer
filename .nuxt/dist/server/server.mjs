import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, computed, defineComponent, unref, h, Suspense, nextTick, mergeProps, provide, createElementBlock, Fragment, withCtx, createVNode, useSSRContext, resolveComponent, resolveDynamicComponent, renderSlot, onServerPrefetch, cloneVNode, toValue, useAttrs, createBlock, createCommentVNode, openBlock, toDisplayString, createTextVNode, onErrorCaptured, createApp } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/vue/index.mjs";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/radix3/dist/index.mjs";
import { defu, defuFn, createDefu } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/defu/dist/defu.mjs";
import { withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/ufo/dist/index.mjs";
import { createSharedComposable } from "@vueuse/core";
import { extendTailwindMerge, twJoin } from "tailwind-merge";
import { klona } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon as Icon$1 } from "@iconify/vue";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderSuspense } from "vue/server-renderer";
import { isEqual, diff } from "ohash/utils";
import { getIconCSS } from "@iconify/utils/lib/css/icon";
import { debounce } from "C:/Users/abdul/Downloads/abdullah-developer/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-BDjc7e1-.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/index-BNGHChJ9.js")
  },
  {
    name: "contact",
    path: "/contact",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/contact-DeiXK_MR.js")
  },
  {
    name: "service",
    path: "/service",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/service-CvNVChxh.js")
  },
  {
    name: "projects",
    path: "/projects",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/projects-yHwzCM3r.js")
  }
];
...
const LazyUAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-mioxsYFe.js").then((r) => r["default"] || r.default || r));
const LazyUAlert = defineAsyncComponent(() => import("./_nuxt/Alert-eyge4hJ1.js").then((r) => r["default"] || r.default || r));
const LazyUAvatar = defineAsyncComponent(() => import("./_nuxt/Avatar-D7j6ya_B.js").then((n) => n.A).then((r) => r["default"] || r.default || r));
const LazyUAvatarGroup = defineAsyncComponent(() => import("./_nuxt/AvatarGroup-Be3R1cd0.js").then((r) => r["default"] || r.default || r));
const LazyUBadge = defineAsyncComponent(() => import("./_nuxt/Badge-Bg5lui1P.js").then((r) => r["default"] || r.default || r));
const LazyUButton = defineAsyncComponent(() => Promise.resolve().then(() => Button).then((r) => r["default"] || r.default || r));
const LazyUButtonGroup = defineAsyncComponent(() => import("./_nuxt/ButtonGroup-DcsCCLCt.js").then((r) => r["default"] || r.default || r));
const LazyUCarousel = defineAsyncComponent(() => import("./_nuxt/Carousel-DuOxlbb0.js").then((r) => r["default"] || r.default || r));
const LazyUChip = defineAsyncComponent(() => import("./_nuxt/Chip-D8owWoZg.js").then((r) => r["default"] || r.default || r));
const LazyUDropdown = defineAsyncComponent(() => import("./_nuxt/Dropdown-UqwNLx7C.js").then((r) => r["default"] || r.default || r));
const LazyUIcon = defineAsyncComponent(() => Promise.resolve().then(() => Icon).then((r) => r["default"] || r.default || r));
const LazyUKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-mTAlBIi1.js").then((r) => r["default"] || r.default || r));
const LazyULink = defineAsyncComponent(() => Promise.resolve().then(() => Link).then((r) => r["default"] || r.default || r));
const LazyUMeter = defineAsyncComponent(() => import("./_nuxt/Meter-A6TeJDcE.js").then((r) => r["default"] || r.default || r));
const LazyUMeterGroup = defineAsyncComponent(() => import("./_nuxt/MeterGroup-U3RrpyLG.js").then((r) => r["default"] || r.default || r));
const LazyUProgress = defineAsyncComponent(() => import("./_nuxt/Progress-vwzpyUnW.js").then((r) => r["default"] || r.default || r));
const LazyUCheckbox = defineAsyncComponent(() => import("./_nuxt/Checkbox-DG6S10z7.js").then((r) => r["default"] || r.default || r));
const LazyUForm = defineAsyncComponent(() => import("./_nuxt/Form-BQSaM1mJ.js").then((r) => r["default"] || r.default || r));
const LazyUFormGroup = defineAsyncComponent(() => import("./_nuxt/FormGroup-GaXdIQ8w.js").then((r) => r["default"] || r.default || r));
const LazyUInput = defineAsyncComponent(() => import("./_nuxt/Input-DXdA7riE.js").then((r) => r["default"] || r.default || r));
const LazyUInputMenu = defineAsyncComponent(() => import("./_nuxt/InputMenu-VdDlcu1r.js").then((r) => r["default"] || r.default || r));
const LazyURadio = defineAsyncComponent(() => import("./_nuxt/Radio-MaYLmbtt.js").then((n) => n.R).then((r) => r["default"] || r.default || r));
const LazyURadioGroup = defineAsyncComponent(() => import("./_nuxt/RadioGroup-BgPNxrPp.js").then((r) => r["default"] || r.default || r));
const LazyURange = defineAsyncComponent(() => import("./_nuxt/Range-DEy-r3Gz.js").then((r) => r["default"] || r.default || r));
const LazyUSelect = defineAsyncComponent(() => import("./_nuxt/Select-DVZO7Y3K.js").then((r) => r["default"] || r.default || r));
const LazyUSelectMenu = defineAsyncComponent(() => import("./_nuxt/SelectMenu-lG-ekGUu.js").then((r) => r["default"] || r.default || r));
const LazyUTextarea = defineAsyncComponent(() => import("./_nuxt/Textarea-CQaetF9H.js").then((r) => r["default"] || r.default || r));
const LazyUToggle = defineAsyncComponent(() => import("./_nuxt/Toggle-BxpyM00U.js").then((r) => r["default"] || r.default || r));
const LazyUTable = defineAsyncComponent(() => import("./_nuxt/Table-JWvBPh83.js").then((r) => r["default"] || r.default || r));
const LazyUCard = defineAsyncComponent(() => import("./_nuxt/Card-Cr-gRBcN.js").then((r) => r["default"] || r.default || r));
const LazyUContainer = defineAsyncComponent(() => import("./_nuxt/Container-D0Yhq39O.js").then((r) => r["default"] || r.default || r));
const LazyUDivider = defineAsyncComponent(() => import("./_nuxt/Divider-fFCR79ok.js").then((r) => r["default"] || r.default || r));
const LazyUSkeleton = defineAsyncComponent(() => import("./_nuxt/Skeleton-5YH4_QBD.js").then((r) => r["default"] || r.default || r));
const LazyUBreadcrumb = defineAsyncComponent(() => import("./_nuxt/Breadcrumb-B8sJBv9_.js").then((r) => r["default"] || r.default || r));
const LazyUCommandPalette = defineAsyncComponent(() => import("./_nuxt/CommandPalette-DqincidL.js").then((r) => r["default"] || r.default || r));
const LazyUCommandPaletteGroup = defineAsyncComponent(() => import("./_nuxt/CommandPaletteGroup-fcvRp9Qx.js").then((r) => r["default"] || r.default || r));
const LazyUHorizontalNavigation = defineAsyncComponent(() => import("./_nuxt/HorizontalNavigation-BlbKy-U9.js").then((r) => r["default"] || r.default || r));
const LazyUPagination = defineAsyncComponent(() => import("./_nuxt/Pagination-RZlx9wBC.js").then((r) => r["default"] || r.default || r));
const LazyUTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-B8CWutPp.js").then((r) => r["default"] || r.default || r));
const LazyUVerticalNavigation = defineAsyncComponent(() => import("./_nuxt/VerticalNavigation-B7HzOmIC.js").then((r) => r["default"] || r.default || r));
const LazyUContextMenu = defineAsyncComponent(() => import("./_nuxt/ContextMenu-3kTVOw4z.js").then((r) => r["default"] || r.default || r));
const LazyUModal = defineAsyncComponent(() => import("./_nuxt/Modal-sk8BeCo6.js").then((r) => r["default"] || r.default || r));
const LazyUModals = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r) => r["default"] || r.default || r));
const LazyUNotification = defineAsyncComponent(() => import("./_nuxt/Notification-CM1fp79r.js").then((r) => r["default"] || r.default || r));
const LazyUNotifications = defineAsyncComponent(() => import("./_nuxt/Notifications-C80pkrL6.js").then((r) => r["default"] || r.default || r));
const LazyUPopover = defineAsyncComponent(() => import("./_nuxt/Popover-CCcWig8T.js").then((r) => r["default"] || r.default || r));
const LazyUSlideover = defineAsyncComponent(() => import("./_nuxt/Slideover-bFqIveus.js").then((r) => r["default"] || r.default || r));
const LazyUSlideovers = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r) => r["default"] || r.default || r));
const LazyUTooltip = defineAsyncComponent(() => import("./_nuxt/Tooltip-CFz7hAoL.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  app: defineAsyncComponent(() => import("./_nuxt/app-C7mrvvP9.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen mx-auto text-center w-full flex flex-col items-center justify-center text-white" }, _attrs))} data-v-49d83686><div class="mt-7 text-7xl font-bold flex error-status"${ssrRenderAttr("title", __props.error.statusCode)} data-v-49d83686>404</div><p class="mt-7 text-6xl" data-v-49d83686> Ooops. </p><p class="mt-7" data-v-49d83686>${ssrInterpolate(__props.error.message)}</p>`);
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-49d83686"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export {
  ...
  appConfig as g,
  button as h,
  getSlotsChildren as i,
  useProvideButtonGroup as j,
  getNuxtLinkProps as k,
  dropdown as l,
  mergeConfig as m,
  useInjectButtonGroup as n,
  omit as o,
  input as p,
  looseToNumber as q,
  get as r,
